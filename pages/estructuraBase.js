...
function createPage(title, content) {
    ...
    html += '<li class="nav-item"><a class="nav-link" href="/projects/?section=mobile">Mobile</a></li>'
    html += '<li class="nav-item"><a class="nav-link" href="/projects/?section=landing">LandingPage</a></li>'
    html += '<li class="nav-item"><a class="nav-link" href="/projects/?section=webapp">Web App</a></li>'
    html += '<li class="nav-item"><a class="nav-link" href="/projects/?section=ecommerce">E-commerce</a></li>'
    html += '<li class="nav-item"><a class="nav-link" href="/projects/?section=games">Games</a></li>'
    html += '<li class="nav-item dark-item yellow"><a class="nav-link nav-link-clientes" href="/clients">CLIENTES</a></li>'
    html += '</ul>'
    html += '</nav>'
    html += '</header>'
    html += content
